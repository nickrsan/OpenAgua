(function() {
  ...
  callWithJQuery(function($) {
    var makePlotlyChart;
    makePlotlyChart = function(chartType, extraOptions) {
      return function(pivotData, opts) {
        ...
        if (chartType === "scatter") {
          ...
          //dataTable = new Plotly.visualization.DataTable();
          ...
          dataTable = Plotly.visualization.arrayToDataTable(dataArray);
        ...
        wrapper = new Plotly.visualization.ChartWrapper({
          dataTable: dataTable,
          chartType: chartType,
          options: options
        });
        ...
        result.bind("dblclick", function() {
          var editor;
          editor = new Plotly.visualization.ChartEditor();
          Plotly.visualization.events.addListener(editor, 'ok', function() {
    ...
    return $.pivotUtilities.plotly_renderers = {
      ...
      "Area Chart": makePlotlyChart("area", {
        isStacked: true
      }),
      "Scatter Chart": makePlotlyChart("scatter")
    };
  });
